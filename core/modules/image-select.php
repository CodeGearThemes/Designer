...
namespace Designer\Core\Modules;
...
class Image_Select extends \Elementor\Base_Data_Control {
	...
	public function enqueue() {
		// styles
		wp_register_style( 'image-choose-control', \Designer::plugin_url() . 'core/modules/assets/css/image-select.css', array(), '1.0.0' );
		wp_enqueue_style( 'image-choose-control' );

		// script
		wp_register_script( 'image-choose-control', \Designer::plugin_url() . 'core/modules/assets/js/image-select.js' );
